...
int main(void)
{
  ...
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 b8 0a 00 00       	push   $0xab8
  ab:	68 cb 07 00 00       	push   $0x7cb
  b0:	e8 b5 02 00 00       	call   36a <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 ce 07 00 00       	push   $0x7ce
  bc:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42f:	f7 f6                	div    %esi
 431:	0f b6 92 1c 08 00 00 	movzbl 0x81c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5a8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5ab:	b8 14 08 00 00       	mov    $0x814,%eax
...
free(void *ap)
{
 ...
 631:	a1 c0 0a 00 00       	mov    0xac0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 687:	89 08                	mov    %ecx,(%eax)
  freep = p;
 689:	a3 c0 0a 00 00       	mov    %eax,0xac0
}
 68e:	5b                   	pop    %ebx
 68f:	5e                   	pop    %esi
 690:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 784:	eb e9                	jmp    76f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 786:	c7 05 c0 0a 00 00 c4 	movl   $0xac4,0xac0
 78d:	0a 00 00 
 790:	c7 05 c4 0a 00 00 c4 	movl   $0xac4,0xac4
 797:	0a 00 00 
    base.s.size = 0;
 79a:	b8 c4 0a 00 00       	mov    $0xac4,%eax
 79f:	c7 05 c8 0a 00 00 00 	movl   $0x0,0xac8
 7a6:	00 00 00 
